...
// in cinta_film/test/presentasi/provider/movie_search_notifier_test.dart.
...
import 'package:cinta_film/domain/usecases/cari_film.dart' as _i4;
...
class MockClassCariFilm extends _i1.Mock implements _i4.ClassCariFilm {
  MockClassCariFilm() {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i7.Film>>> execute(String? query) =>
